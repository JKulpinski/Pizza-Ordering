...
///////////////                        PRODUKTY            //////////////////////// 
    ...
    void obrazki(Produkty prod) {
        ...
        String img_path = VaadinService.getCurrent().getBaseDirectory().getAbsolutePath();
        //System.out.println(img_path);
        FileResource resource = new FileResource(new File(img_path + "/WEB-INF/pizza/" + key + ".png"));
