...
public class Konsola extends UI {
    ...
    void szukanie_filtrowane() {
        ...
        widok.addComponents(desc, info, szukana, wybor, szukaj, new Button("Pokaż wszystkie", click -> getPage().setLocation("http://pizza.eu-west-1.elasticbeanstalk.com/jonasz/filter_pizza?name=")));

        szukaj.addClickListener(click -> {
            String url = "http://pizza.eu-west-1.elasticbeanstalk.com/jonasz/filter_pizza?";
            boolean ok = true;
